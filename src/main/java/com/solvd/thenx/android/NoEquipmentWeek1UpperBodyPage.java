...
@DeviceType(pageType = DeviceType.Type.ANDROID_PHONE, parentClass = NoEquipmentWeek1UpperBodyPageBase.class)
public class NoEquipmentWeek1UpperBodyPage extends NoEquipmentWeek1UpperBodyPageBase implements IMobileUtils {
    ...
    public NoEquipmentWeek1UpperBodyPage(WebDriver driver) {
        super(driver);
    }
